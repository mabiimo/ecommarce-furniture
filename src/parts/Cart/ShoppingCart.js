  ...
  return (
    <div className="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
      ...
      <div className="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
        <div className="px-4 flex-none">
          <div className="" style={{ width: 90, height: 90 }}>
            <img src="./images/content/chair-1.png" alt="chair-1" className="object-cover rounded-xl w-full h-full" />
          </div>
        </div>
      ...
      <div className="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="2">
        <div className="px-4 flex-none">
          <div className="" style={{ width: 90, height: 90 }}>
            <img src="./images/content/chair-2.png" alt="chair-2" className="object-cover rounded-xl w-full h-full" />
          </div>
        </div>
        <div className="px-4 w-auto flex-1 md:w-5/12">
          <div className="">
      ...
      <div className="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="3">
        <div className="px-4 flex-none">
          <div className="" style={{ width: 90, height: 90 }}>
            <img src="./images/content/chair-3.png" alt="chair-3" className="object-cover rounded-xl w-full h-full" />
          </div>
        </div>
        <div className="px-4 w-auto flex-1 md:w-5/12">
          <div className="">
